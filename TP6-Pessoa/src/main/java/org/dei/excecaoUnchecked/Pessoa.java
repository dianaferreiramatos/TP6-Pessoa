...
public class Pessoa implements Comparable<Pessoa> {
     ...
     */
    public Pessoa(String nome, int idCivil) throws ArgumentoForaDosLimitesException{
        setNome(this.nome);
        setIDCivil(this.idCivil);
    }
     ...
     */    
    public Pessoa() throws ArgumentoForaDosLimitesException{
     ...
     */
    public Pessoa(Pessoa outraPessoa) throws ArgumentoForaDosLimitesException{
     ...
     */
    public void setNome(String nome) throws ArgumentoForaDosLimitesException {
        char c;
     ...
     */
    public void setIDCivil(int idCivil)throws ArgumentoForaDosLimitesException {
        ...
        if (idCivil < 0 || numDig >8 || idCivil == 0) {
            throw new ArgumentoForaDosLimitesException();
        }
